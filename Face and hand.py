...
"""
face_hand_tracker.py
Face + Hand tracker using MediaPipe and OpenCV.

Features:
 - Face mesh landmarks (468 points) drawn on the face.
 - Hand landmarks for left/right hands (21 points).
 - Simple finger-count for each hand (thumb + 4 fingers).
 - FPS counter, bounding boxes, landmark indices optional.
